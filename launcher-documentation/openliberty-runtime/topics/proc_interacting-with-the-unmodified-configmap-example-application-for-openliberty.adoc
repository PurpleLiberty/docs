[id='interacting-with-the-unmodified-configmap-booster-for-openliberty_{context}']
[id='interacting-with-the-unmodified-configmap-example-application-for-openliberty_{context}']
= Interacting with the unmodified {name-example-configmap} example application for {OpenLiberty}
