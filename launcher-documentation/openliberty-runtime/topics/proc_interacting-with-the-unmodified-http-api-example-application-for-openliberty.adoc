[id='interacting-with-the-unmodified-http-api-booster-for-openliberty_{context}']
[id='interacting-with-the-unmodfied-http-api-example-application-for-openliberty_{context}']
= Interacting with the unmodified {name-example-http-api} example application for {OpenLiberty}
