...
:name-guide-openliberty: {OpenLiberty} Runtime Guide
...
:link-example-cache-openliberty: {link-guide-openliberty}#example-cache-openliberty
...
:link-example-circuit-breaker-openliberty: {link-guide-openliberty}#example-circuit-breaker-openliberty
...
:link-example-configmap-openliberty: {link-guide-openliberty}#example-configmap-openliberty
...
:link-example-crud-openliberty: {link-guide-openliberty}#example-crud-openliberty
...
:link-example-health-check-openliberty: {link-guide-openliberty}#example-health-check-openliberty
...
:link-example-http-api-openliberty: {link-guide-openliberty}#example-rest-http-openliberty
...
:link-example-secured-openliberty: {link-guide-openliberty}#example-rest-http-secured-openliberty
