...
For a step-by-step tutorial on deploying microservices to OpenShift, see the https://www.openliberty.io/guides/cloud-openshift.html[Deploying microservices to OpenShift guide].
...
This Operator also offers other production-grade capabilities, including simple configuration of persistent or advanced storage and https://www.openliberty.io/docs/latest/reference/feature/socialLogin-1.0.html[the ability to delegate single-sign on (SSO) to external providers].
...
== See also
Guide: https://www.openliberty.io/guides/kubernetes-intro.html[Deploying microservices to Kubernetes]
