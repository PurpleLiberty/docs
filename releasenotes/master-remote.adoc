...
include::https://raw.githubusercontent.com/OpenLiberty/blogs/master/publish/2020-03-13-access-specific-kafka-properties-samesite-20003.adoc[leveloffset=+1,tags=intro;run;features]
