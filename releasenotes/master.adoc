...
<httpEndpoint  id="defaultHttpEndpoint" host="*" httpPort="8941" httpsPort="8946" > <tcpOptions soReuseAddr="true" /> </httpEndpoint>
  ...
  <!-- more applicaERROR: Image missing: tmp/en-US/xml/images/20001-highcpuload.png
 at /usr/share/perl5/vendor_perl/HTML/Element.pm line 1564.
tion config would go here -->
